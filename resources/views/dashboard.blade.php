    ...
    <div class="row mb-4">
        <div class="col-md-4 mb-4">
            <div class="bg-white card-box shadow-sm">
                ...
                <div class="d-flex align-items-center mb-3">
                    <img src="{{ asset('Assets/logo/zoom.png') }}" alt="Zoom" style="width: 40px; height: 40px;"
                        class="me-2">
                ...
                @foreach ($meetRequest as $row)
                    <div class="d-flex align-items-center justify-content-between border-bottom py-2">
                        <div style="max-width: 220px;">
                            <p class="fw-semibold mb-1">{{ $row['topik'] }}</p>
                            <small class="text-muted d-block">Time: {{ $row['jumlahJam'] }}</small>
        ...
        <div class="col-md-4 mb-4">
            <div class="bg-white card-box shadow-sm">
                ...
                <!-- Header -->
                <div class="d-flex align-items-center mb-3">
                    <img src="{{ asset('Assets/logo/schedule.png') }}" alt="Zoom" style="width: 40px; height: 40px;"
                        class="me-2">
                    <h5 class="mb-0 fw-bold">Meeting Schedule</h5>
                </div>

                <!-- Loopable Content -->
                @foreach ($meetSchedule as $row)
                    <div class="d-flex align-items-center justify-content-between border-bottom py-2">
                        <div style="max-width: 220px;">
                            <p class="fw-semibold mb-1">{{ $row['topic'] }}</p>
                            <small class="text-muted d-block">Time:
                                {{ date('Y-m-d H:i:s', strtotime($row['start_time'])) }}</small>
                            <small class="text-muted d-block">Participants: -</small>
                        </div>
                        <div class="align-item-center">
                            <a target="_blank" href="{{ $row['join_link'] }}" class="btn btn-success btn-sm">Confirm</a>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="col-md-4">
            <div class="bg-white card-box shadow-sm">
                ...
                <div class="d-flex align-items-center justify-content-between border-bottom py-2">
                    ...
                    <div class="align-item-center">
                        <a href="https://wa.me/6281223896063" target="_blank" class="btn btn-success btn-sm">
                            Chat Now
                        </a>
                ...
                <div class="d-flex align-items-center justify-content-between border-bottom py-2">
                    ...
                    <div class="align-item-center">
                        <a href="https://wa.me/62895636145822" target="_blank" class="btn btn-success btn-sm">
                            Chat Now
                        </a>
